...
const u8 gText_Brawly[] = _("JAN");
const u8 gText_Winona[] = _("WINONA");
const u8 gText_Phoebe[] = _("PHOEBE");
const u8 gText_Glacia[] = _("GLACIA");
const u8 gText_Petalburg[] = _("LEEUWARDEN");
const u8 gText_Slateport[] = _("ALKMAAR");
const u8 gText_Littleroot[] = _("ASSEN"); // Unused. Given the context, Briney may at one point have been able to sail the player here
...
const u8 gText_Dewford[] = _("DEN BURG");
...
const u8 gText_LilycoveCity[] = _("MAASTRICHT");
const u8 gText_SlateportCity[] = _("ALKMAAR");
